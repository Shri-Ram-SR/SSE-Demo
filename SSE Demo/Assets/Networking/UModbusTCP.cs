...
public class UModbusTCP : MonoBehaviour {
    ...
    /// <param name="_sIp">IP adress of modbus slave.</param>
    /// <param name="_usPort">Port number of modbus slave. Usually port 502 is used.</param>
    public bool Connect(string _sIp, ushort _usPort, CONNECTION_MODE _eConnectionMode = CONNECTION_MODE.LINEAR) {
        m_sIp = _sIp;
        m_usPort = _usPort;
        try {
            IPAddress oIp;
            ...
            switch(_eConnectionMode) {
                ...
                default:
                    ...
                    {
                        IOManager.Instance.NotConnected(e.ToString());
                    }
                    Debug.Log("Connected");
                    break;
            }
            ...
            m_bAsyncConnected = false;
            //return false;
            IOManager.Instance.NotConnected(_oError.ToString());
            throw (_oError);
        }
